...
## [5.1.2](https://github.com/instantOS/instantMENU/compare/v5.1.1...v5.1.2) - 2026-09-26

### Fixed

- starting up while holding keys discards some input
- optimize font latency further
- scroll bursts looking weird
- coalesce pointer motion into scroll bursts too
- scroll/hover flickering
- stop hover and paging fighting over the selection
...
- ascii fast path for font runs
- unify menu item acceptance across input paths

### Fixed

- single letter mode width
- improve emoji handling

### Other

- fix frecency late arrival
